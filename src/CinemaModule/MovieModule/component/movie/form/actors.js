...
const convertValue = (value) => ({target: {value:  value}});
export default (props) => {
    console.log(props);
    const ids = props.actors.map(actor => actor.id.personId) || [];
    console.log(ids);
    return (
        <form>
